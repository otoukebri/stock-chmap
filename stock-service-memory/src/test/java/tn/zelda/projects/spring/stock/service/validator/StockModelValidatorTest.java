...
public class StockModelValidatorTest {
    ...
    public void validateModelInvalidNameTest() throws ApiBadRequestException {
        ...
        stockModelValidator.validateSaveStockModel(new StockModel("Reebok","", 120.9));
    }


    @Test
    public void validateModelInvalidCodeTest() throws ApiBadRequestException {
        exception.expect(ApiBadRequestException.class);
        stockModelValidator.validateSaveStockModel(new StockModel("","RB", 120.9));
    }

    @Test
    public void validateModelInvalidPriceTest() throws ApiBadRequestException {
        exception.expect(ApiBadRequestException.class);
        stockModelValidator.validateSaveStockModel(new StockModel("Reebok","RB", null));
    }
}
